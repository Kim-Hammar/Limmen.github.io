...
![Fig. 3](/assets/thesis_digest_3.png "The architecture of the software platform that implements our framework (CSLE). It is a distributed system with N servers (N=6 in this example), which are connected through a database (the metastore) and a virtualization layer provided by Docker Swarm.")
...
![Fig. 4](/assets/thesis_digest_4.png "A digital twin in our framework is a virtual replica of a target system that runs the same software but on virtualized hardware.")
...
![Fig. 5](/assets/thesis_digest_5.png "Target systems for the use cases in the evaluation. The detailed system configurations are available in the thesis.")
