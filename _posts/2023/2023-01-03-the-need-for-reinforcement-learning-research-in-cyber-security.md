...
![The IT infrastructure and the actors in the use case.](/assets/blog/shared/method_use_case.png "Figure 1: The IT infrastructure and the actors in the use case"){: width="200" .center}
...
![Our approach for finding automated intrusion response strategies](/assets/blog/shared/method_approach.png "Figure 2: Our approach for finding automated intrusion response strategies"){: width="400" .center}
