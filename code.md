...
**A multiagent incident response system**; This repository includes the code of a multiagent incident response system that autonomously investigates security incidents and recommends optimized response actions. [Code repository](https://github.com/Kim-Hammar/multiagent-incident-response); [Video demonstration](https://www.youtube.com/watch?v=YXYk_5GCqUI).

**5G Cloud RAN measurements**; We release a novel dataset comprising 168 hours of monitoring data collected from our 5G testbed. [Data repository](https://huggingface.co/datasets/kimhammar/5G_measurements).

**Code and data for incident response LLM fine-tuning**; This repository contains the artifacts related to the paper "Incident Response Planning Using a Lightweight Large Language Model with Reduced Hallucination", which is accepted to The Network and Distributed System Security (NDSS) Symposium 2026. We introduce a novel method that enables the effective use of a large language model (LLM) to provide decision support for incident response planning. [Code repository](https://github.com/Kim-Hammar/llm_incident_response_ndss26); [Data repository](https://huggingface.co/datasets/kimhammar/CSLE-IncidentResponse-V1); [Video demonstration](https://www.youtube.com/watch?v=XXo4Y6LCWk4).
...
[Code repository](https://github.com/Kim-Hammar/awesome-rl-for-cybersecurity).
...
[Code repository](https://github.com/Kim-Hammar/gym-optimal-intrusion-response)
...
[Code repository](https://github.com/Kim-Hammar/gym-idsgame).
...
[Code repository](https://github.com/Kim-Hammar/FastTextOnSpark).
...
[Code repository](https://github.com/Kim-Hammar/mlfd_prototype).
...
[Code repository](https://github.com/Kim-Hammar/erl_pengine).
...
[Code repository](https://github.com/Kim-Hammar/Distributed-KV-store).
...
[Code repository](https://github.com/Kim-Hammar/KompicsLogoot).
...
[Code repository](https://github.com/Kim-Hammar/Basic_SSL_VPN).

**SemWebTutorial**; Semantic Web Tutorial.
[Code repository](https://github.com/Kim-Hammar/SemWeb_Tutorial);
...
[Code repository](https://github.com/Kim-Hammar/Advent-Of-Code16-Prolog).

**DataMining**; Implementation of various data mining algorithms.
[Code repository](https://github.com/Kim-Hammar/DataMining);
[Report](/assets/papers/data_mining_project.pdf).

**AgentProgramming**; Programing of Multi-Agent Systems
[Code repository](https://github.com/Kim-Hammar/AgentProgramming);
